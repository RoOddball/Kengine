...
void spherePrimitiveByLines(SDL_Renderer* gRenderer, SDL_Point center, int radius){
	...
	SDL_Point* points = (SDL_Point*)malloc(sizeof(SDL_Point)*circumference_of_circle);
